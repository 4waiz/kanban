      ...
      <div className="mx-auto max-w-360">
        <div className="mb-16 flex flex-col gap-6">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-kanban-text/60">
            Five practice areas, each rooted in projects we have already shipped. Each is a credible
            specialty backed by deployed work, research publications, and competition wins — not
            marketing claims.
          </p>
        </div>
